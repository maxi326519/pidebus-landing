...
function crearTarjeta(viaje) {
  ...
  card.innerHTML = `
    ...
    <div class="div__card">
      ...
      <span class="reembol" >${viaje.reembolsable === true ? 'Reembolsable' : ''}</span>
      <button  type="button" data-toggle="collapse" data-target="#collapse-${viaje.id}" aria-expanded="false" aria-controls="collapse-${viaje.id}" class="btn btn_naranja btn_ver">
        <div class="d-flex flex-row align-items-center justify-content-center">
